            ...
            if ($stmt->num_rows == 1) {
                ...
                if (password_verify($password, $hashed_password)) {
                    ...
                    echo "<script>
                            ...
                            window.location.href = 'user-dashboard.php'; // Immediate redirect
                          </script>";
                } else {
                    // Redirect back to login page on invalid password
                    echo "<script>alert('Wrong email and password. Please try again.'); window.location.href = 'login.html';</script>";
                }
            } else {
